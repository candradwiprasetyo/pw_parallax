<!-- pricing section BEGIN  -->
    <section class="pricing" id="pricing">
      <div class="container">
        <div class="title text-center wow animated fadeInDown"><h1>Pricing Table</h1></div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="pricing-table wow animated fadeInUp" data-wow-delay="0.6s">
            <div class="header"><h3>Medium</h3></div>
            <div class="price"><span class="textbold">$5</span> / hours</div>
            <div class="list">
              <ul>
                <li><span class="textbold">Up to</span> 5 Users</li>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="pricing-table active wow animated fadeInUp" data-wow-delay="0.9s">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="pricing-table wow animated fadeInUp" data-wow-delay="1.2s">
            <div class="header"><h3>Professional</h3></div>
            <div class="price"><span class="textbold">$5</span> / hours</div>
            <div class="list">
              <ul>
                <li><span class="textbold">Up to</span> 5 Users</li>
